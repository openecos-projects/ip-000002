...
SIM_INC ?=
SIM_INC += +incdir+../rtl/
SIM_INC += +incdir+../rtl/interface
SIM_INC += +incdir+../rtl/verif
...
comp:
	@mkdir -p build
	cd build && ($(SIM_TOOL) $(SIM_OPTIONS) -top $(SIM_TOP) -l compile.log $(addprefix ../,$(SRC_FILE)) $(SIM_INC))
